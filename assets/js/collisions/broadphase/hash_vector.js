// на будущее -- сделать класс AnimatedProperty, который может по разным интерполяциям изменять себя.
// В script, сделать относительный старт от предыдущего элемента через +-
// Инициализировать и отображать основные объекты. Не нужно в разных функциях инициализировать. 
