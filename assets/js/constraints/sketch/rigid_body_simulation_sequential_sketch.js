import impulses_cube from '../../../js/constraints/rigid_body_simulation.min.js';
import main_visualizator_namespace from '../../../js/common/main_vis.min.js';
import p5 from '../../../js/libs/p5.min.js';

{
  let my_interface = new impulses_cube.Interface("rigid_body_simulation_sequential_sketch", true, true);
