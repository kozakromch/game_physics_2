...
import common_vis_namespace from '/game_physics_2/js/common/common_vis.min.js';
import energy_namespace from '/game_physics_2/js/common/energy.min.js';
import sinusoidal_namespace from '/game_physics_2/js/common/sinusoidal_vis.min.js';
