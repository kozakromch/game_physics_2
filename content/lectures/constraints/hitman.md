...
В такой схеме если не до конца разрешать ограничения, то может получиться дополнительная скорость. Эта проблема решается дополнительным трением при коллизии.

### Трение

сила трения прямо пропорциональна силе реакции опоры. В этом же случае вместо того, чтобы высчитывать эту силу, была использована глубина проникновения одного тела в другое.
