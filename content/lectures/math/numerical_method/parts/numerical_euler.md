...
{{< image path="numerical_method/stable_zone_forward.excalidraw.png" >}}
...
{{< image path="numerical_method/accuracy_forward.excalidraw.png" >}}
...
{{< image  path="numerical_method/stable_zone_backward.excalidraw.png" >}}
